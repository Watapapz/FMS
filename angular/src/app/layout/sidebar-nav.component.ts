...
export class SideBarNavComponent extends AppComponentBase {
    ...
    menuItems: MenuItem[] = [
        ...
        new MenuItem(this.l('School'), '', 'menu', '', [
            new MenuItem(this.l('Students'),'','','/app/school/students'),
            //new MenuItem(this.l(''),'','','/app/school/student')
        ]),
        //new MenuItem(this.l('BankAccounts'), '', 'shopping_cart', '/app/bank-account'),
